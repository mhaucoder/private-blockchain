...
peer lifecycle chaincode package ${PWD}/chaincode/private_chaincode_v1.tar.gz --path ${PWD}/../dev_extcc --lang node --label private_chaincode_v1_1.0
sleep 3
PACKAGE_ID=$(peer lifecycle chaincode calculatepackageid ${PWD}/chaincode/private_chaincode_v1.tar.gz)

#Install chanicode on peer PC02
setOrgPC02
peer lifecycle chaincode install ${PWD}/chaincode/private_chaincode_v1.tar.gz
...
#Approved chaincode on peer PC02
setOrgPC02
peer lifecycle chaincode approveformyorg -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem --channelID pc02-private-channel --name private_chaincode_v1 --version 1.0 --package-id ${PACKAGE_ID} --sequence 1 --signature-policy "OR('PC02-PMSP.peer')"

#Commit chaincode
peer lifecycle chaincode commit -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --channelID pc02-private-channel --name private_chaincode_v1 --version 1.0 --sequence 1 --signature-policy "OR('PC02-PMSP.peer')" --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem --peerAddresses pc02-p1.pc02.gov.vn:8051 --tlsRootCertFiles ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem

#Invoke chaincode
peer chaincode invoke -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem -C pc02-private-channel -n private_chaincode_v1 -c '{"function":"UserContract:initializeDataDefault","Args":["dev"]}'
sleep 1
peer chaincode invoke -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem -C pc02-private-channel -n private_chaincode_v1 -c '{"function":"RoleContract:initializeDataDefault","Args":["dev"]}'
sleep 1
peer chaincode invoke -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem -C pc02-private-channel -n private_chaincode_v1 -c '{"function":"OrganizationContract:initializeDataDefault","Args":["dev"]}'
sleep 1
peer chaincode invoke -o localhost:8050 --ordererTLSHostnameOverride pc02-o1.pc02.gov.vn --tls --cafile ${PWD}/organizations/memberOrganizations/pc02.gov.vn/tlsca/tlsca.pc02.gov.vn-cert.pem -C pc02-private-channel -n private_chaincode_v1 -c '{"function":"PermissionContract:initializeDataDefault","Args":["dev"]}'