...
docker volume rm private_blockchain_catphcm-p1.catphcm.gov.vn
docker volume rm private_blockchain_catphcm-o1.catphcm.gov.vn
docker volume rm private_blockchain_pc02-p1.pc02.gov.vn
docker volume rm private_blockchain_pc02-o1.pc02.gov.vn
